...
class Next2 extends StatefulWidget{
  @override
  State<Next2> createState() => _YesState();
}

class _YesState extends State<Next2> {
  bool isfinal = true;
  @override
  void initState() {
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text("I am AKELA",textAlign:TextAlign.center,style:TextStyle(fontSize: 23),),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(top: 40),
                            child: ClipRRect(
                          ...
                          SizedBox(height: 20,),
                          Text("Without You.......",style: TextStyle(fontSize: 18),),
                          SizedBox(height: 40,),
                           Container(
                            width: 170,
                             child: Padding(
